...
import { C, VOUCHERS } from "../constants";
...
function PricingPage({ user, eventName, guestCount, onClose, onPlanSelected }) {
  ...
  const handlePay = (tier) => {
    ...
    if (tier.price === 0 || finalPrice === 0) {
      onPlanSelected?.(tier.id, appliedVoucher?.code || null, 0);
      return;
    }
      ...
      <div style={{ maxWidth: 880, width: "100%", margin: "auto" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          ...
          {guestCount !== undefined && (
            <p style={{ color: theme.textMuted, fontSize: 14, margin: 0 }}>
              ...
              <strong
                style={{
                  color: TIERS.find((t) => t.id === recommended)?.color,
                }}
              >
                {TIERS.find((t) => t.id === recommended)?.label}{" "}
                {t.recommended}
              </strong>
            </p>
          )}
        ...
        >
          {TIERS.map((tier) => {
            ...
            const finalPrice =
              appliedVoucher && tier.price > 0
                ? Math.round(
                    tier.price *
                      (1 - appliedVoucher.discount / 100)
                  )
                : tier.price;
            ...
            return (
              <div
                ...
                style={{
                  background: isRec ? theme.card : theme.cardAlt,
                  border: isRec
                ...
                <div style={{ marginBottom: 20 }}>
                  ...
                  <span
                    style={{
                      fontSize: 38,
                      fontWeight: 800,
                      color: discounted ? C.green : theme.text,
                    }}
                  >
                  ...
                  {discounted && (
                    ...
                    >
                      ...
                      {t.withCode(appliedVoucher.code)}
                    </div>
                  )}
                </div>
            ...
            >
              <input
                ...
                style={{
                  ...
                  border: `1px solid ${
                    voucherError ? "#e05252" : theme.border
                  }`,
                  borderRadius: 8,
                  color: theme.text,
                  fontSize: 13,
        ...
        >
          {paypalEmail ? t.paypalFooter : t.paypalNotConfigured}
        </div>
      </div>
    </div>
  );
