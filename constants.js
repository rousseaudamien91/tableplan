...
const TRANSLATIONS = {
  ...
  es: {
    ...
    importDrop: "Arrastra tu archivo aquí",
    importPreview: "Vista previa",
    importDuplicates: "duplicados encontrados",
    importBtn: "Importar",
    onboardingType: "¿Qué tipo de evento?",
    onboardingName: "Nombra tu evento",
    onboardingGuests: "¿Cuántos invitados?",
    onboardingTemplate: "Plano de sala",
    searchGlobal: "Buscar en todos los eventos...",
    notifRsvp: "Nueva respuesta RSVP",
  ...
  de: {
    ...
    importExcel: "Excel / CSV importieren",
    importDrop: "Datei hier ablegen",
    importPreview: "Import-Vorschau",
    importDuplicates: "Duplikate gefunden",
    importBtn: "Importieren",
    onboardingType: "Welche Art von Veranstaltung?",
    onboardingName: "Veranstaltung benennen",
    onboardingGuests: "Wie viele Gäste?",
    onboardingTemplate: "Raumlayout",
    searchGlobal: "In allen Veranstaltungen suchen...",
    notifRsvp: "Neue RSVP-Antwort",
  ...
  it: {
    ...
    importExcel: "Importa Excel / CSV",
    importDrop: "Trascina il file qui",
    importPreview: "Anteprima importazione",
    importDuplicates: "duplicati trovati",
    importBtn: "Importa",
    onboardingType: "Che tipo di evento?",
    onboardingName: "Dai un nome all'evento",
    onboardingGuests: "Quanti ospiti?",
    onboardingTemplate: "Layout sala",
    searchGlobal: "Cerca in tutti gli eventi...",
    notifRsvp: "Nuova risposta RSVP",
